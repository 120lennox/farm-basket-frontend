        ...
        <div>
          <div>
            <div>
              ...
              <div className="mt-8">
                <button className="bg-gray-400 p-4 px-10 rounded-2xl font-normal">
                  Get Started
                </button>
              </div>
            </div>
            <div className="w-[950px]">
              <p className="text-[32px]">
                From Seeds to Harvest: Your One-Stop Shop for All Things
                Agriculture Seeds to Harvest: Your One-Stop Shop for All Things
                Agriculture Your Harvest: Your One-Stop Shop for All Things
                Agriculture
              </p>
            </div>
